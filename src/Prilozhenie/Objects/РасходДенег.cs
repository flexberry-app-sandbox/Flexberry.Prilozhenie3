...
namespace IIS.Prilozhenie
{
    ...
    [View("РасходДенегE", new string[] {
            ...
            "ИНН as \'ИНН\'",
            "БИК as \'БИК\'",
            "Поставщики as \'Поставщик\'",
            "Поставщики.Наименование as \'Наименование\'",
            "Финансисты as \'Финансисты\'",
            "Финансисты.ФИО as \'Финансисты ФИО\'",
            "Сумма as \'Сумма\'"}, Hidden=new string[] {
            "Поставщики.Наименование",
            "Финансисты.ФИО"})]
    [AssociatedDetailViewAttribute("РасходДенегE", "ПереченьМат", "ПереченьМатE", true, "", "Перечень мат", true, new string[] {
            ""})]
    ...
    public class РасходДенег : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie.Банк fБанк;
        ...
        private IIS.Prilozhenie.Поставщики fПоставщики;
        
        private IIS.Prilozhenie.Финансисты fФинансисты;
        
        private IIS.Prilozhenie.DetailArrayOfПереченьМат fПереченьМат;
        ...
        public virtual IIS.Prilozhenie.Банк Банк
        {
            get
            {
                ...
                IIS.Prilozhenie.Банк result = this.fБанк;
        ...
        [PropertyStorage(new string[] {
                "Поставщики"})]
        [NotNull()]
        public virtual IIS.Prilozhenie.Поставщики Поставщики
        {
            get
            {
                ...
                IIS.Prilozhenie.Поставщики result = this.fПоставщики;
        ...
        public virtual IIS.Prilozhenie.DetailArrayOfПереченьМат ПереченьМат
        {
            get
            {
                ...
                {
                    this.fПереченьМат = new IIS.Prilozhenie.DetailArrayOfПереченьМат(this);
                }
                IIS.Prilozhenie.DetailArrayOfПереченьМат result = this.fПереченьМат;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасходДенегE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасходДенегE", typeof(IIS.Prilozhenie.РасходДенег));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасходДенегL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасходДенегL", typeof(IIS.Prilozhenie.РасходДенег));
                }
            }
        }
    }
